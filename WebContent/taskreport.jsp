...
<%
	...
	String sql="select id,title,status,uid,priority,createdon from tasks WHERE pid=? and uid=? and status=?";
	
	List<Map<String,String>> todo=DbHelper.executeDQL(sql, pid,uid,"6");
	List<Map<String,String>> testing=DbHelper.executeDQL(sql, pid,uid,"12");
	List<Map<String,String>> inprogress=DbHelper.executeDQL(sql, pid,uid,"8");
	List<Map<String,String>> done=DbHelper.executeDQL(sql, pid,uid,"14");
%>
